...
import 'package:new_mvc_quizbook/Utils/api_common_model.dart';
...
class ApiController {
  ...
  static Future<ApiResponse> post(String url, String body) async {
    ...
    try {
      ...
      var client = http.Client();
      print("api $url $body");
      final response = await client.post(Uri.parse(url), body: body, headers: headers).timeout(timeOutDuration);
